...
自作リバーシ CPU (FPGA / MCU / ソフトウェア) が [61-UART プロトコル仕様](../../../docs/reversi/61-UARTプロトコル仕様.md) に
...
- [docs/reversi/61-UARTプロトコル仕様.md](../../../docs/reversi/61-UARTプロトコル仕様.md) — 仕様本体
- [docs/reversi/67-リプレイテスト.md](../../../docs/reversi/67-リプレイテスト.md) — 参照 CPU の回帰テスト (本ツールとは別物)
- [docs/reversi/58-自作CPUオセロ大会ルール.md](../../../docs/reversi/58-自作CPUオセロ大会ルール.md) — 大会ルール (本ツールの通過が出場条件になる想定)
